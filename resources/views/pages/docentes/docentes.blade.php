                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="codigo_docente">Código de Docente</label>
                                <input type="number" id="codigo_docente" name="codigo_docente" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="nombre_docente">Nombre Completo</label>
                                <input type="text" id="nombre_docente" name="nombre_docente" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="identificacion_docente">Identificación</label>
                                <input type="number" id="identificacion_docente" name="identificacion_docente" class="form-control">
                            </div>
                            <div class="form-group">
