...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('semestres.semestre5.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="codigo_curso_semestre5">Código de Curso</label>
                                <input type="text" id="codigo_curso_semestre5" name="codigo_curso_semestre5" class="form-control">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="text-center">
                       <div class="action-btns">
                        <a href="{{ route('semestres.semestre5.index')}}" class="btn btn-danger">
