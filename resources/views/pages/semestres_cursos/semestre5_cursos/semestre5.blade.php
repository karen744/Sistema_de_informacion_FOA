...
<body>
    <div>
        <a href="{{ route('semestres.semestre5.create') }}" class="btn btn-primary" style="margin-right: 400px" >Registro cursos</a>
    </div>
    <br>
  ...
  <div class="row" style="margin-left: 500px; margin-top: -400px">
      @forelse ($curso_semestre5 as $curso)
          <div class="col-md-4 mb-4">
              <div class="card">
                  <div class="card-body">
                      <h5 class="card-title">{{ $curso->nombre_curso }}</h5>
                      <p class="card-text">Código Curso: {{ $curso->codigo_curso_semestre5 }}</p>
                      <div class="d-flex align-items-center justify-content-center mt-5">
                          <a href="{{ route('semestres.semestre5.show', $curso->codigo_curso_semestre5) }}" class="btn btn-primary d-flex align-items-center me-3">Ver detalles</a>
                      </div>
                  </div>
              </div>
          </div>
